package com.example.requestlab.core.navigation
...
import com.example.requestlab.core.designsystem.components.dotGridBackground
import com.example.requestlab.feature.builder.ui.BuilderScreen
import com.example.requestlab.feature.collections.ui.CollectionsScreen
import com.example.requestlab.feature.docs.ui.DocsScreen
import com.example.requestlab.feature.history.ui.HistoryScreen
        ...
        NavDisplay(
            ...
            entryProvider = entryProvider {
                ...
                entry<HistoryDetailDestination> { dest ->
                    com.example.requestlab.feature.history.ui.HistoryDetailScreen(
                        entryId = dest.id,
                ...
                entry<CollectionDetailDestination> { dest ->
                    com.example.requestlab.feature.collections.ui.CollectionDetailScreen(
                ...
                entry<EnvironmentsDestination> {
                    com.example.requestlab.feature.environments.ui.EnvironmentsScreen(
                        onNavigateToDetail = { id -> backStack.add(EnvironmentDetailDestination(id)) },
                        onBack = { backStack.removeLastOrNull() },
                    )
                }
                entry<EnvironmentDetailDestination> { dest ->
                    com.example.requestlab.feature.environments.ui.EnvironmentDetailScreen(
                        environmentId = dest.id,
                        onBack = { backStack.removeLastOrNull() },
                    )
                }
                entry<SettingsDestination> {
                    com.example.requestlab.feature.settings.ui.SettingsScreen(
                        onBack = { backStack.removeLastOrNull() },
                    )
                }
                ...
                entry<DocsArticleDestination> { dest ->
                    com.example.requestlab.feature.docs.ui.DocsArticleScreen(
                        articleId = dest.id,
                        onBack = { backStack.removeLastOrNull() },
                    )
                }
